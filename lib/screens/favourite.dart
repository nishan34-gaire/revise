...
class _wishState extends State<wish> {
  ...
  int mov = 0;
  Future<Find> search(int mov) async {
    var client = http.Client();
    var uri = Uri.parse(
        'https://api.themoviedb.org/3/search/movie?api_key=8be08cce18954a0aecc4f2c57f7d992b&language=en-US&query=$mov&page=1&include_adult=false');
